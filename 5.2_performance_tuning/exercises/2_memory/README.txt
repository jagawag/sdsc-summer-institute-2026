...
srun --partition=<given_partition> --res=<reservation> --account=<given_account> --pty --nodes=1 --ntasks-per-node=1 --mem=64G -c 4 -t 00:30:00 /bin/bash
...
Now measure how long it takes to compute 50^2 matrix 163840 times (128*128*100):
